...
if (NOT PICO_EXTRAS_PATH AND EXISTS "${LOCAL_EXTRAS_PATH}/CMakeLists.txt")
    set(PICO_EXTRAS_PATH "${LOCAL_EXTRAS_PATH}")
    message(STATUS "Using local pico-extras from submodule: ${PICO_EXTRAS_PATH}")
endif()

# Check environment variable (only if local extras not found)
if (DEFINED ENV{PICO_EXTRAS_PATH} AND (NOT PICO_EXTRAS_PATH))
    set(PICO_EXTRAS_PATH $ENV{PICO_EXTRAS_PATH})
...
if (NOT PICO_EXTRAS_PATH)
    if (PICO_EXTRAS_FETCH_FROM_GIT)
        ...
        if (PICO_SDK_PATH AND EXISTS "${PICO_SDK_PATH}/../pico-extras")
            ...
            message(STATUS "Defaulting PICO_EXTRAS_PATH as sibling of PICO_SDK_PATH: ${PICO_EXTRAS_PATH}")
        else()
            message(FATAL_ERROR
